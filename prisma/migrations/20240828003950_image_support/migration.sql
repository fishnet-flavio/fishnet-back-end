...
INSERT INTO "new_products" ("announcedAt", "description", "id", "name", "price", "stock", "updatedAt", "vendor_id") SELECT "announcedAt", "description", "id", "name", "price", "stock", "updatedAt", "vendor_id" FROM "products";
DROP TABLE "products";
